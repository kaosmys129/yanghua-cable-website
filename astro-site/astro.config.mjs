...
export default defineConfig({
  ...
  redirects: {
    ...
    '/en/products/category/fire-resistant': { status: 301, destination: '/en/products/category/fire-resistant-cables' },
    '/en/products/category/general': { status: 301, destination: '/en/products/category/general-purpose-cables' },
    ...
    '/es/productos/category/fire-resistant': { status: 301, destination: '/es/productos/categoria/cables-resistentes-al-fuego' },
    '/es/productos/categoria/flame-retardant': { status: 301, destination: '/es/productos/categoria/cables-retardantes-de-llama' },
    '/es/productos/categoria/general': { status: 301, destination: '/es/productos/categoria/cables-de-proposito-general' },
    '/es/products/category/cables-libres-de-humo-y-halógenos': { status: 301, destination: '/es/productos/categoria/cables-libres-de-humo-y-halogenos' },
    '/es/products/category/cables-libres-de-humo-y-hal%C3%B3genos': { status: 301, destination: '/es/productos/categoria/cables-libres-de-humo-y-halogenos' },
    '/es/productos/category/cables-libres-de-humo-y-halógenos': { status: 301, destination: '/es/productos/categoria/cables-libres-de-humo-y-halogenos' },
    '/es/productos/category/cables-libres-de-humo-y-hal%C3%B3genos': { status: 301, destination: '/es/productos/categoria/cables-libres-de-humo-y-halogenos' },
    ...
    '/en/articles/2ikgue6k': { status: 301, destination: '/en/articles/flexible-busbar-industry-solutions-solar-pv-with-complete-manual-download-instructions-517369' },
    '/en/articles/6s9rfzeo': { status: 301, destination: '/en/articles/another-breakthrough-flexible-busbar-assists-energy-storage-project-implementation-560298' },
    '/en/articles/90gnzqpu': { status: 301, destination: '/en/articles/supporting-xinjiang-s-belt-and-road-construction-flexible-busbar-always-on-the-road-532899' },
    '/en/articles/esz5g5ao': { status: 301, destination: '/en/articles/factory-rooftop-distributed-solar-projects-flexible-busbar-handles-it-with-ease-966599' },
    '/es/articulos/invitation-april-10-12-13th-international-energy-storage-summit-exhibition-high-current-flexible-busbar-booth-b2119-hall-b2-es': { status: 301, destination: '/es/articulos/invitacion-10-12-de-abril-13a-cumbre-y-exposicion-internacional-de-almacenamiento-de-energia-busbar-flexible-de-alta-corriente-stand-b2119-salon-b2-515322' },
    '/es/articles/high-current-flexible-busbar-officially-debuts-in-dongguan-yanghuasti-dongguan-alliance-partner-product-promotion-successfully-held-es': { status: 301, destination: '/es/articulos' },
    '/es/articulos/high-current-flexible-busbar-officially-debuts-in-dongguan-yanghuasti-dongguan-alliance-partner-product-promotion-successfully-held-es': { status: 301, destination: '/es/articulos' },
    '/es/articulos/yanghuasti-2024-annual-review-es': { status: 301, destination: '/es/articulos/revision-anual-de-yanghuasti-2024-528905' },
    '/es/articulos/ten-years-of-chamber-platform-building-dreams-high-current-flexible-busbar-moving-forward-with-honor-es': { status: 301, destination: '/es/articulos/diez-anos-de-construccion-de-plataforma-de-la-camara-de-comercio-busbar-de-alta-corriente-flexible-avanzando-con-honor-859905' },
    '/es/articles/yanghua-insights-chemical-plant-multi-core-cable-connections-causing-problems-vs-flexible-busbar-easy-solutions-es': { status: 301, destination: '/es/articulos/perspectivas-de-yanghua-conexiones-de-cables-multicore-en-plantas-quimicas-causando-problemas-vs-soluciones-faciles-con-busbar-flexible-532260' },
    '/es/articulos/yanghua-insights-chemical-plant-multi-core-cable-connections-causing-problems-vs-flexible-busbar-easy-solutions-es': { status: 301, destination: '/es/articulos/perspectivas-de-yanghua-conexiones-de-cables-multicore-en-plantas-quimicas-causando-problemas-vs-soluciones-faciles-con-busbar-flexible-532260' },
    '/es/products/flexible-busbar-2000a': { status: 301, destination: '/es/productos/flexible-busbar-2000a' },
    '/es/articulos/new-infrastructure-track-new-energy-vehicle-charging-pile-development-new-infrastructure-new-busbar-series-sharing-es': { status: 301, destination: '/es/articulos' },
    '/es/articulos/flexible-busbar-industry-solutions-charging-stations-with-complete-manual-download-instructions-es': { status: 301, destination: '/es/articulos/soluciones-de-industria-de-busbar-flexible-estaciones-de-carga-con-instrucciones-completas-de-descarga-del-manual-527307' },
    ...
    '/es/solutions/metallurgy': { status: 301, destination: '/es/soluciones/metallurgy' },
    ...
    '/pt/solucoes/fabricação': { status: 301, destination: '/pt/solucoes/manufacturing' },
    '/pt/solucoes/fabrica%C3%A7%C3%A3o': { status: 301, destination: '/pt/solucoes/manufacturing' },
